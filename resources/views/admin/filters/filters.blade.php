                    ...
                    <div class="col-lg-12 grid-margin stretch-card"> 
                        <div class="card"> 
                            <div class="card-body"> 
                              ...
                              @endif
                              <a style="max-width: 172px; float: left; display:inline-block;" href="{{ url('admin/add-edit-filter') }}" 
                                class="btn btn-block btn-primary">Add Filter Columns</a>
                                <a style="max-width: 165px; float: right; display:inline-block;" href="{{ url('admin/filters-value') }}" 
                              ...
                              @foreach ($filters as $filter)
                                <tr> 
                                     ...
                                     <td> @if($filter['status']==1)   &nbsp;
                                            <a text="Active" class="updateFilterStatus" id="filter-{{$filter['id']}}" filter_id="{{$filter['id']}}"
                                                href="javascript:void(0)"> 
                                            <i style="font-size:30px" class="mdi mdi-check-circle" status="Active"> </i> </a>
                                          @else  &nbsp;
                                          <a text="Inactive" class="updateFilterStatus" id="filter-{{$filter['id']}}" filter_id="{{$filter['id']}}"
                                                href="javascript:void(0)"> 
